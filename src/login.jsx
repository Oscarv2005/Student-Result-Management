...
function Login({ onAuthSuccess }) {
  ...
  const handleAuthAction = async (e, forceAction = null) => {
    ...
    if (!credentials.username || !credentials.password) {
      setAlert({
        type: "error",
        message: "Please supply all credential tracks.",
      });
      return;
    }
    ...
    try {
      ...
      if (result.success) {
        if (actionType === "register") {
          setAlert({
            type: "success",
            message: "Registration successful! Proceeding to log you in...",
          });
          try {
            ...
            setAlert({
              type: "error",
              message: "Automatic login failed. Please use the Sign In action.",
            });
          }
        } else {
          setAlert({
            type: "success",
            message: "Authentication approved. Loading workspace...",
          });
      ...
      setAlert({
        type: "error",
        message: "Network error. Core server line offline.",
      });
    }
  };
